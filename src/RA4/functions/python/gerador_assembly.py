...
class GeradorAssembly:
    ...
    def __init__(self):
        ...
        # Usando apenas registradores r0-r15 para compatibilidade com AVR-GCC
        # Pares: R0:R1, R2:R3, R4:R5, R6:R7, R8:R9, R10:R11, R12:R13, R14:R15
    ...
    def _processar_multiplicacao_16bit(self, instr: Dict[str, Any]) -> List[str]:
        ...
        asm.extend([
            ...
            f"    mov r0, r4",
            f"    mov r1, r5",
            f"    ldi r2, 100             ; Divide by scale factor",
            f"    ldi r3, 0",
    ...
    def _processar_if_goto(self, instr: Dict[str, Any]) -> List[str]:
        ...
        return [
            ...
            f"    ldi r2, 0                  ; Zero constant for comparison",
            f"    ldi r3, 0",
    ...
    def _gerar_prologo(self) -> List[str]:
        ...
        return [
            ...
            "    ldi r0, lo8(0x08FF)   ; RAMEND low byte",
            "    out 0x3D, r0          ; SPL",
            "    ldi r0, hi8(0x08FF)   ; RAMEND high byte",
            "    out 0x3E, r0          ; SPH",
            "",
    ...
    def _gerar_rotina_divisao_16bit(self) -> List[str]:
        ...
        return [
            ...
            "    ldi     r4, 0xFF     ; Quociente = 0xFFFF (indicador de erro)",
            "    ldi     r5, 0xFF",
    ...
    def _gerar_rotinas_uart(self) -> List[str]:
        ...
        return [
            ...
            "uart_init:",
            "    ldi r0, 0",
            "    sts 0xC5, r0        ; UBRR0H = 0",
            "    ldi r0, 8",
            "    sts 0xC4, r0        ; UBRR0L = 8 (115200 baud @ 16MHz)",
            "    ldi r0, (1 << 3)    ; TXEN0",
            "    sts 0xC1, r0        ; UCSR0B",
            "    ldi r0, (1 << 2) | (1 << 1)",
            "    sts 0xC2, r0        ; UCSR0C (8N1)",
            "    ret",
            "",
            "uart_transmit:",
            "    push r1",
