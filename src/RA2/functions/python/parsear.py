...
TIPO_PARA_SIMBOLO = {
    ...
    Tipo_de_Token.VARIAVEL: 'variavel',
    Tipo_de_Token.ABRE_PARENTESES: 'abre_parenteses',
    Tipo_de_Token.FECHA_PARENTESES: 'fecha_parenteses',
    Tipo_de_Token.SOMA: 'soma',
    Tipo_de_Token.SUBTRACAO: 'subtracao',
    Tipo_de_Token.MULTIPLICACAO: 'multiplicacao',
    Tipo_de_Token.DIVISAO_INTEIRA: 'divisao_inteira',
    Tipo_de_Token.DIVISAO_REAL: 'divisao_real',
    Tipo_de_Token.RESTO: 'resto',
    Tipo_de_Token.POTENCIA: 'potencia',
    Tipo_de_Token.MENOR: 'menor',
    Tipo_de_Token.MAIOR: 'maior',
    Tipo_de_Token.IGUAL: 'igual',
    Tipo_de_Token.MENOR_IGUAL: 'menor_igual',
    Tipo_de_Token.MAIOR_IGUAL: 'maior_igual',
    Tipo_de_Token.DIFERENTE: 'diferente',
    Tipo_de_Token.AND: 'and',
    Tipo_de_Token.OR: 'or',
    Tipo_de_Token.NOT: 'not',
